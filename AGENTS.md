...
bounded job-history reads and startup-migration repair is also shipped. T30.6o
authorization-first retention-status shell and capacity warning is next,
followed by T30.6p core SurrealDB retention collectors, T30.6q the exact 24-table
