...
func TestCorrectedInspectionInventoryIsPhaseAndEpochDerived(t *testing.T) {
	...
	for index, phase := range frozenPhaseOrder() {
		...
		if phase == "preflight" || phase == "teardown" {
			if rows[index] != (phaseInspectionInventory{Phase: phase, TransitionReadClass: "none"}) {
	...
	wantRows := []phaseInspectionInventory{
		...
		{Phase: "process_restart", ServerEpoch: 4, HealthCalls: CounterBound{Minimum: 1, Maximum: 3_601}, ExtractionProgressCalls: CounterBound{Minimum: 1, Maximum: 2_881}, FinalAuthorityPasses: exactInspectionCalls(1), TransitionReadClass: "prepared-checkpoint-hard-restart"},
		{Phase: "pressure_80", ServerEpoch: 4, ExtractionProgressCalls: exactInspectionCalls(1), FinalAuthorityPasses: exactInspectionCalls(1), LifecycleStatusCalls: CounterBound{Minimum: 1, Maximum: 241}, TransitionReadClass: "pressure-normalization-and-collect-cycle", ImmutableMemberReusePhase: "process_restart"},
		{Phase: "pressure_90", ServerEpoch: 4, ExtractionProgressCalls: exactInspectionCalls(1), FinalAuthorityPasses: exactInspectionCalls(1), TransitionReadClass: "typed-pressure-refusal", ImmutableMemberReusePhase: "pressure_80"},
		{Phase: "pressure_75", ServerEpoch: 4, ExtractionProgressCalls: exactInspectionCalls(1), FinalAuthorityPasses: exactInspectionCalls(1), LifecycleStatusCalls: CounterBound{Minimum: 1, Maximum: 241}, TransitionReadClass: "pressure-refusal-removal-and-recovery-cycle", ImmutableMemberReusePhase: "pressure_90"},
		...
		{Phase: "lifecycle_collection", ServerEpoch: 5, ExtractionProgressCalls: exactInspectionCalls(1), FinalAuthorityPasses: exactInspectionCalls(1), LifecycleStatusCalls: CounterBound{Minimum: 1, Maximum: 2_881}, TransitionReadClass: "fresh-fourteen-owner-cycle", ImmutableMemberReusePhase: "archive_restore"},
