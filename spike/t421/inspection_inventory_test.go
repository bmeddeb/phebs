...
func TestCorrectedInspectionInventoryIsPhaseAndEpochDerived(t *testing.T) {
	...
	wantEpochs := []epochInspectionInventory{
		...
		{ServerEpoch: 4, HealthCallsMaximum: 3_601, ExtractionProgressCallsMaximum: 2_884, TailReadinessCallsMaximum: 2_884, TailControlFileReadsMaximum: 11_536, TailStoreReadAttemptsMaximum: 11_536, FinalAuthorityPassesMaximum: 4, LifecycleStatusCallsMaximum: 482, TransitionReadCallsMaximum: 3, TransitionControlFileReadsMaximum: 7, TransitionStoreReadAttemptsMaximum: 4, AccountedServerRequestsMaximum: 6_257},
