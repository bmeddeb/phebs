// Command t392-receipt verifies a frozen private plan and emits only the
// closed, source-free T39.2 operating-envelope receipt.
package main
...
func main() {
	...
	receipt, err := t392.BuildReceipt(plan, observation, *planDigest)
	if err != nil {
...
func fail(format string, args ...any) {
	_, _ = fmt.Fprintf(os.Stderr, "t392-receipt: "+format+"\n", args...)
	os.Exit(1)
}
