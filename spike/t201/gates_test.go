...
func TestCurrentExtractionBaseline(t *testing.T) {
	...
	want := []ExtractionMeasurement{
		{Domain: "grpc-caller", Version: "1.3.0", Facts: 4, UnresolvedCount: 4, Predicates: map[string]int{
			"UNRESOLVED_CALLER": 4,
		}},
		...
		{Domain: "scip-proto-field", Version: "1.1.0", Predicates: map[string]int{}},
		{Domain: "scip-thrift-field", Version: "1.1.0", Predicates: map[string]int{}},
		{Domain: "thrift-caller", Version: "1.3.0", Facts: 1, UnresolvedCount: 1, Predicates: map[string]int{
			"UNRESOLVED_CALLER": 1,
		}},
