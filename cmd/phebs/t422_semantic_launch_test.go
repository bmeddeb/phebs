...
func TestT422SemanticClosedHTTPRecipes(t *testing.T) {
	for _, test := range []struct {
		...
		{"retention-pin", "POST", t422RetentionPinPath, false, true},
		{"marked-retention-pin", "POST", t422RetentionPinPath, true, false},
		{"retention-read", "GET", t422RetentionReadPath, true, true},
		{"unmarked-retention-read", "GET", t422RetentionReadPath, false, false},
