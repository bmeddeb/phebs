...
| [GATE0_READINESS.md](./GATE0_READINESS.md) | descriptive audit of every Gate 0 requirement against current reality, including the external-benchmark charter conflict; decides nothing |
