...
| [GATE0_READINESS.md](./GATE0_READINESS.md) | descriptive audit of every Gate 0 requirement against current reality, including the proposed v0.2 resolution of the external-benchmark conflict; decides nothing |
