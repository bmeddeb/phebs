...
2026-08-06, closing Epic 37. T38.1's exact selected-service overview and
T38.2's cross-service explorer completed on 2026-08-06; T38.3 is scheduled next.
...
T37.5 completed on 2026-08-06. T38.1's exact service overview and T38.2's
cross-service explorer are complete; T38.3 is scheduled.
Epics 25–28 remain
...
- **Epic 38 — microservice product (T38.1–T38.2 complete; T38.3 next):** the
  exact selected-service overview and source-first cross-service explorer are
  complete; change-impact workflows, UI/API/MCP parity, and the end-to-end
  neutral demo remain.
