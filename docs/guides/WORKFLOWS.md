...
| `/api/caller-generation-progress?repository=`                    | GET             | authorization-first declaration-independent exact caller-generation state, aggregate counts, bounded partition progress/refusals, and analysis scope |
