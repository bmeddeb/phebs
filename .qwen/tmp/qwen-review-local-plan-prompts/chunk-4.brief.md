You are reviewing chunk 4 of 9 of a code diff.

Your territory: lines 845-921 of the diff (77 lines, 3129 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/search/searcher.go (new-side lines 1070-1188)
- internal/sync/reconcile.go (new-side lines 370-393)
...
Then, on its own final line: `Covered: chunk 4 lines 845-921`