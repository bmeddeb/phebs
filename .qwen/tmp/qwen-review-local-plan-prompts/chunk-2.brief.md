You are reviewing chunk 2 of 9 of a code diff.

Your territory: lines 157-461 of the diff (305 lines, 19751 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- docs/BACKLOG_COMPLETED.md (new-side lines 8761-8824)
- docs/ROADMAP.md (new-side lines 108-720)
- docs/guides/CONFIGURATION.md (new-side lines 81-96)
- docs/guides/OPERATIONS.md (new-side lines 2810-2866)
- internal/focusedindex/archive.go (new-side lines 851-864)
- internal/focusedindex/publication.go (new-side lines 135-198)
...
Then, on its own final line: `Covered: chunk 2 lines 157-461`