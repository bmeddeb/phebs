You are reviewing chunk 8 of 9 of a code diff.

Your territory: lines 1890-2269 of the diff (380 lines, 12939 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/search_generation_lifecycle.go (new-side lines 1-374)
...
Then, on its own final line: `Covered: chunk 8 lines 1890-2269`