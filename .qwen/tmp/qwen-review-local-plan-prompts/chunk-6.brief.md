You are reviewing chunk 6 of 9 of a code diff.

Your territory: lines 1321-1719 of the diff (399 lines, 13129 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/search_generation.go (new-side lines 394-792)
...
Then, on its own final line: `Covered: chunk 6 lines 1321-1719`