You are reviewing chunk 9 of 9 of a code diff.

Your territory: lines 2270-2583 of the diff (314 lines, 10995 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/search_generation_lifecycle.go (new-side lines 375-402)
- internal/focusedindex/search_generation_test.go (new-side lines 1-230)
- internal/lifecycle/search.go (new-side lines 1-44)
...
Then, on its own final line: `Covered: chunk 9 lines 2270-2583`