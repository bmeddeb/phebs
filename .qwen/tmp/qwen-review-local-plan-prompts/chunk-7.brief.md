You are reviewing chunk 7 of 9 of a code diff.

Your territory: lines 1720-1889 of the diff (170 lines, 5807 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/search_generation.go (new-side lines 793-927)
- internal/focusedindex/search_generation_bytes_other.go (new-side lines 1-7)
- internal/focusedindex/search_generation_bytes_unix.go (new-side lines 1-16)
...
Then, on its own final line: `Covered: chunk 7 lines 1720-1889`