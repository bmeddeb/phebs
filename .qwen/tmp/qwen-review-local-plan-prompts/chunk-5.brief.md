You are reviewing chunk 5 of 9 of a code diff.

Your territory: lines 922-1320 of the diff (399 lines, 15838 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/search_generation.go (new-side lines 1-393)
...
Then, on its own final line: `Covered: chunk 5 lines 922-1320`