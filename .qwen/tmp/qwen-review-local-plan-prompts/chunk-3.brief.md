You are reviewing chunk 3 of 9 of a code diff.

Your territory: lines 462-844 of the diff (383 lines, 15322 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- internal/focusedindex/publication.go (new-side lines 206-226)
- internal/indexer/binary_internal_test.go (new-side lines 3-56)
- internal/indexer/indexer.go (new-side lines 182-533)
- internal/indexer/indexer_test.go (new-side lines 470-533)
- internal/lifecycle/policy.go (new-side lines 30-41)
- internal/lifecycle/static.go (new-side lines 53-58)
- internal/search/searcher.go (new-side lines 6-1030)
...
Then, on its own final line: `Covered: chunk 3 lines 462-844`