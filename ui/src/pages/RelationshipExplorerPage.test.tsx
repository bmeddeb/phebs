...
test('waits for one exact service key before creating a relationship binding', () => {
  ...
  const help = screen.getByRole('button', { name: 'Help for Relationship explorer' })
  fireEvent.click(help)
  expect(screen.getByRole('dialog', { name: 'Relationship explorer help' })).toBeTruthy()
  expect(screen.getByText(/Static source evidence does not prove runtime execution/)).toBeTruthy()
